...
setblock ~ ~ ~1 repeater[facing=north] destroy
...
summon text_display ~0.015 ~0.14 ~-0.29 {Tags:["redstone_receiver_text"],text:'[{"score":{"name":"##system","objective":"redstone_link"}}]',Rotation:[180F,-90F]}