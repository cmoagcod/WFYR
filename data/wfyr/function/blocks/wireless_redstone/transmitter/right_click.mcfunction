execute if score @e[distance=0..1,sort=nearest,tag=redstone_transmitter,limit=1] redstone_link matches 1.. run scoreboard players remove @e[distance=0..1,sort=nearest,tag=redstone_transmitter,limit=1] redstone_link 1
