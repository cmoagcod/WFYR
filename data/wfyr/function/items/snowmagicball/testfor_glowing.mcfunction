...
execute as @a[scores={snow_magic_give=1}] run give @s stick[minecraft:custom_name="[{'text':'Avanceur ciblé','italic':false}]",minecraft:food={saturation:0,nutrition:0,eat_seconds:10000000,can_always_eat:true},minecraft:item_name=SnowTeleporter,minecraft:max_stack_size=1,minecraft:custom_model_data=20]
