advancement revoke @s only wfyr:quests/items/jumpquest
scoreboard players add @s jump_quest 0
execute at @s if score @s jump_quest matches 0 run playsound minecraft:ui.toast.challenge_complete master @s ~ ~ ~
